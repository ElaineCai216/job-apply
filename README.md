...
- **投递台账**：一张明确的表记录「什么时候投了什么公司、什么渠道、有没有回音」——含投递日期、渠道、回音（暂无回音 / 有回音·面试·Offer…）、阶段、内推码、跟进日期；支持搜索、筛选、新增/编辑/删除，按投递日期倒序；**新增时粘贴链接自动识别渠道与公司名；公司/职位可留空**（留空时用链接域名/「未命名公司」显示，稍后可补）
- **我的简历**：直接上传 PDF / Word 简历文件（自动设为默认版本），无需手动填写；可重命名版本、下载、删除
